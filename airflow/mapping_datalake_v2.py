...
jar_file = 'hdfs:/user/allieart/cartographie/carte_carto-1.0.jar' # 'hdfs:/projects/k******/carte_carthgraphique/carte_carto-1.0.jar'
conf_path = '/user/allieart/cartographie/conf' # '/projects/k******/carte_cartographique/conf' 
output_path = '/user/allieart/cartographie/output' # '/projects/k******/carte_carthgraphique/output' 
